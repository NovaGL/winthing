...
/**
 * Windows implementation of desktop operations via JNA/Win32 API.
 *
 * @since 1.0.0
 */
public class WindowsDesktopService implements DesktopService {
    ...
    @Inject
    public WindowsDesktopService(final User32 user32) {
    ...
    public void closeActiveWindow() {
        getForegroundWindow().ifPresent(this::closeWindow);
    }

    @Override
    public void setDisplaySleep(final boolean sleep) {
        getForegroundWindow().ifPresent(hwnd ->
