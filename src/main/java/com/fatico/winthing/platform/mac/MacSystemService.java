...
/**
 * macOS implementation of system operations using osascript and native commands.
 *
 * @since 2.0.0
 */
public class MacSystemService implements SystemService {
    ...
    public void suspend() throws SystemException {
        ShellExecutor.execute("pmset", "sleepnow");
    }

    @Override
    public void hibernate() throws SystemException {
        // macOS doesn't have a separate hibernate; use deep sleep
        ShellExecutor.execute("pmset", "sleepnow");
    }
    ...
    public void open(final String uri) throws SystemException {
        try {
            ShellExecutor.executeAsync("open", Objects.requireNonNull(uri));
        } catch (Exception ex) {
            try {
